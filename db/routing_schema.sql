-- routing.db schema
-- qwen_tasks: 22 активных задачи
-- parallel_config: 13 стратегий маршрутизации
...
-- Стратегии:
-- qwen_only: только Qwen локально
-- parallel: Qwen + HF + tavily одновременно
-- external_first: HF + browser + tavily
-- qwen_with_context: tavily даёт данные -> Qwen обрабатывает
